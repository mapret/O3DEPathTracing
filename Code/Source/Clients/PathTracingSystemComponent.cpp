...
{
    AZ_COMPONENT_IMPL(PathTracingSystemComponent, "PathTracingSystemComponent",
        PathTracingSystemComponentTypeId);

    void PathTracingSystemComponent::Reflect(AZ::ReflectContext* context)
    {
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<PathTracingSystemComponent, AZ::Component>()
                ->Version(0)
                ;
        }
    }
    ...
    void PathTracingSystemComponent::GetRequiredServices([[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& required)
    {
    }

    void PathTracingSystemComponent::GetDependentServices([[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& dependent)
    {
    }
    ...
    void PathTracingSystemComponent::OnTick([[maybe_unused]] float deltaTime, [[maybe_unused]] AZ::ScriptTimePoint time)
    {
    }
